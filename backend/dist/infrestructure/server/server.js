...
const userwork_routes_1 = __importDefault(require("../../interfaces/routes/userwork.routes"));
...
const usercomment_routes_1 = __importDefault(require("../../interfaces/routes/usercomment.routes"));
...
class Server {
    ...
    routes() {
        ...
        this.app.use('/api/userworks', userwork_routes_1.default);
        this.app.use('/api/comments', usercomment_routes_1.default);
    }
    middlewares() {
