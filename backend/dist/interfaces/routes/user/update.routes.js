...
router.put('/update/:userId', verifyAdmin_1.verifyAdmin, update_controller_1.updateUser);
router.get('/update/getUser/:userId', verifyAdmin_1.verifyAdmin, update_controller_1.getInfoUser);
