...
import permission from "../../../infrestructure/models/user/permission";
import {permissionsCatalog} from "../../../infrestructure/models/user/permission";
import { permissionsPerUserType } from '../../../infrestructure/models/user/permission';
