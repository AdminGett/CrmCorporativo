...
import { userService } from '../../../services/user/navbar.service';
import { ActivatedRoute } from '@angular/router';
import { ToastrService } from 'ngx-toastr';

import { permissionsService } from 'src/services/user/permission.service';
import { permissions } from 'shared/dto/permission.dto';


@Component({
  selector: 'app-gerente-permissions',
  templateUrl: './gerente-permissions.component.html',
  styleUrls: ['./gerente-permissions.component.scss'],
  standalone: false
})
export class GerentePermissionsComponent implements OnInit {
//Variable para userID
  userId!: number;
